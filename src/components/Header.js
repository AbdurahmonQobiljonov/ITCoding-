  ...
  return (
    <header className="header" id="header">
      <div className="header_container">
        ...
        <div className={first ? 'header_controll active' : 'header_controll'} id="controll">
            ...
            <div className="header_login">
              <div className="header_login-in">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  />
                  <path d="M20 12H7M7 12L10 9M7 12L10 15" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>

                <p>Kirish</p>
              </div>
              <button className="header_login-btn btn btn-outline">ro‘yxatdan o‘tish</button>
            </div>
          </nav>
        </div>

        <div className={first ? 'burger active' : 'burger'} id="burger" onClick={() => setFirst(() => !first)}></div>
      </div>
    </header>
  );
};
